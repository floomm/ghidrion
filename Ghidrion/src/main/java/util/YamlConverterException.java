 ...
 * YAML to @{@link MorionInitTraceFile} resp. {@link MorionTraceFile} conversion.
 * It provides a title for categorizing the exception and an associated message to describe the error.
 */
public class YamlConverterException extends Exception {
	...
	/**
     * Constructs a YamlConverterException with the specified title, message, and underlying cause.
     *
     * @param title   the title of the exception
     * @param message the message describing the error
